...
var gameState = 'notStarted',   //started or ended in setGameElements();
    player = {
        name: '',
        score: 0
    },
...
var displayWinner = document.getElementById('js-displayWinner'),
    displayPlayerMatchWon = document.getElementById('js-playerMatchesWon'),
    displayCompMatchWon = document.getElementById('js-computerMatchesWon');

var compMatchesWon = 0,
    playerMatchesWon = 0;
...
function whoWon() {
    if (player.score == 10) {
        gameState = 'ended';
        displayWinner.innerHTML = 'Zwycięzcą jest ' + player.name;
        playerMatchesWon += 1;
        displayPlayerMatchWon.innerHTML = playerMatchesWon;
        setGameElements();
        }
    if (computer.score == 10) {
        gameState = 'ended';
        displayWinner.innerHTML = 'Zwycięzcą jest komputer';
        compMatchesWon +=1;
        displayCompMatchWon.innerHTML = compMatchesWon;
        setGameElements();
    }
}
